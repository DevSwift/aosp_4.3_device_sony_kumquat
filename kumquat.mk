...
$(call inherit-product, device/sony/kumquat/recovery/recovery.mk)
...
PRODUCT_COPY_FILES += \
    ...
    device/sony/kumquat/config/01stesetup:system/etc/init.d/01stesetup \
    device/sony/kumquat/config/10dhcpcd:system/etc/init.d/10dhcpcd \
    device/sony/kumquat/config/10hostapd:system/etc/init.d/10hostapd \
...
# Custom init / uevent
PRODUCT_COPY_FILES += \
    device/sony/kumquat/config/init.rc:root/init.rc \
    device/sony/kumquat/config/fstab.st-ericsson:root/fstab.st-ericsson \
    device/sony/kumquat/config/init.st-ericsson.rc:root/init.st-ericsson.rc \
    device/sony/kumquat/config/ueventd.st-ericsson.rc:root/ueventd.st-ericsson.rc
